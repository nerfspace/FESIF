...
/**
 * Parse sold prices from an eBay Finding API `findCompletedItems` response.
...
/**
 * HTML-scraping fallback implementation for sold prices
 * (used when EBAY_APP_ID is absent).
 *
 * @param {string} query
